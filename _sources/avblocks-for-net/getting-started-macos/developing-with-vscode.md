...
2. [Download](https://github.com/avblocks/avblocks-net-core/releases/) the Darwin version of AVBlocks for .NET (net10.0). The file you need will have a name similar to `avblocks-net10.0-v3.3.0-demo.1-darwin.zip` - the version number may differ. 
